...
export const characters: Character[] = [
  ...
  // NEW NINJA CHARACTER USING ninja.png
  {
    id: 'shadow-ninja',
    name: 'Shadow Ninja',
    class: 'shadow-ninja',
    ...
    moveSet: [
      ...
      },
      {
        ...
        currentCooldown: 0,
        range: 180,
        description: 'Throws multiple ninja stars at once',
        animation: 'ninja-stars'
      },
      {
        id: 'shadow-dash',
        name: 'Shadow Dash',
      ...
      },
      {
        ...
        currentCooldown: 0,
        range: 0,
        description: 'Creates smoke cloud for stealth and evasion',
        animation: 'smoke-bomb'
      },
      {
        id: 'shadow-clone',
        name: 'Shadow Clone',
