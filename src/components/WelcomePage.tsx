...
const WelcomePage: React.FC<WelcomePageProps> = ({ onEnter }) => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 via-indigo-900 to-black text-white relative overflow-hidden responsive-p-4">
      ...
      <div className={`w-full max-w-6xl text-center relative z-10 transition-all duration-1000 px-4 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        
        {/* Main Title */}
        <div className="mb-8">
          <div className="flex items-center justify-center mb-4">
            <Crown className="text-yellow-400 mr-3 animate-pulse" size={36} />
            <h1 className="responsive-text-4xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 animate-pulse">
              FIGHTER'S
            </h1>
            <Crown className="text-yellow-400 ml-3 animate-pulse" size={36} />
          </div>
          <h2 className="responsive-text-3xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-blue-500 to-cyan-400 mb-3">
            REALM
          </h2>
          <div className="flex items-center justify-center space-x-3 responsive-text-lg text-gray-300 mb-6">
        ...
        {/* Feature Highlights */}
        <div className="grid grid-cols-1 md:grid-cols-3 responsive-gap-4 lg:gap-6 mb-10">
          <div 
            className="bg-gradient-to-br from-red-900/40 to-red-700/20 backdrop-blur-sm responsive-p-4 lg:p-6 rounded-xl border border-red-500/30 transition-all duration-300 transform hover:scale-105"
          ...
          >
            ...
            <h3 className="responsive-text-lg font-bold mb-2 text-red-300">Intense Combat</h3>
          ...
          <div 
            className="bg-gradient-to-br from-blue-900/40 to-blue-700/20 backdrop-blur-sm responsive-p-4 lg:p-6 rounded-xl border border-blue-500/30 transition-all duration-300 transform hover:scale-105"
          ...
          >
            ...
            <h3 className="responsive-text-lg font-bold mb-2 text-blue-300">Open World</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
          ...
          <div 
            className="bg-gradient-to-br from-purple-900/40 to-purple-700/20 backdrop-blur-sm responsive-p-4 lg:p-6 rounded-xl border border-purple-500/30 transition-all duration-300 transform hover:scale-105"
          ...
          >
            ...
            <h3 className="responsive-text-lg font-bold mb-2 text-purple-300">Character Growth</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
        ...
        {/* Game Stats */}
        <div className="flex flex-wrap justify-center responsive-gap-4 mb-8">
          <div className="bg-black/40 backdrop-blur-sm rounded-lg px-4 py-2 border border-yellow-400/30">
            <div className="responsive-text-2xl font-bold text-yellow-400">6+</div>
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-lg px-4 py-2 border border-green-400/30">
            <div className="responsive-text-2xl font-bold text-green-400">15+</div>
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-lg px-4 py-2 border border-blue-400/30">
            <div className="responsive-text-2xl font-bold text-blue-400">100+</div>
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-lg px-4 py-2 border border-purple-400/30">
            <div className="responsive-text-2xl font-bold text-purple-400">∞</div>
        ...
        <div className="relative mb-8">
          <button 
            type="button"
            className="group px-16 py-4 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-400 hover:via-orange-400 hover:to-red-400 rounded-xl font-bold responsive-text-2xl text-black transition-all duration-500 cursor-pointer select-none transform hover:scale-110 shadow-2xl relative overflow-hidden"
        ...
        {/* Game Features */}
        <div className="grid grid-cols-2 md:grid-cols-4 responsive-gap-4 mb-6 text-sm">
        ...
        {/* Controls Preview */}
        <div className="bg-black/50 backdrop-blur-sm rounded-lg responsive-p-4 border border-gray-600/50 mb-4">
          <h3 className="responsive-text-lg font-bold mb-3 text-yellow-400">⚔️ COMBAT CONTROLS ⚔️</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 responsive-gap-4 text-sm">
            <div className="text-center">
              <div className="bg-gray-700 rounded-lg px-2 py-1 mb-1 font-mono text-sm">WASD</div>
              <div className="text-gray-300">Movement</div>
            </div>
            <div className="text-center">
              <div className="bg-gray-700 rounded-lg px-2 py-1 mb-1 font-mono text-sm">SPACE</div>
              <div className="text-gray-300">Attack</div>
            </div>
            <div className="text-center">
              <div className="bg-gray-700 rounded-lg px-2 py-1 mb-1 font-mono text-sm">2</div>
              <div className="text-gray-300">Shuriken</div>
            </div>
            <div className="text-center">
              <div className="bg-gray-700 rounded-lg px-2 py-1 mb-1 font-mono text-sm">SHIFT</div>
