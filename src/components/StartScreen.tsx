...
const StartScreen: React.FC<StartScreenProps> = ({ onStart, onBack }) => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-b from-slate-900 via-purple-900 to-black text-white responsive-p-4 relative overflow-hidden">
      {/* Back Button */}
      <button
        onClick={onBack}
      ...
      <div className="max-w-6xl w-full text-center relative z-10">
        <div className="mb-6">
          <h1 className="responsive-text-4xl lg:text-5xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 animate-pulse">
            Fighter's Realm
          </h1>
          <div className="flex items-center justify-center space-x-2 responsive-text-lg text-gray-300 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 responsive-gap-4 lg:gap-6 mb-8">
          <div 
            className="bg-gray-800 bg-opacity-60 responsive-p-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-red-500/20"
          ...
          <div 
            className="bg-gray-800 bg-opacity-60 responsive-p-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-blue-500/20"
          ...
          <div 
            className="bg-gray-800 bg-opacity-60 responsive-p-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-purple-500/20"
          ...
          <div 
            className="bg-gray-800 bg-opacity-60 responsive-p-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-green-500/20"
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-center responsive-gap-4 mb-6">
          {/* Shop Button */}
          <div className="relative">
            <button 
              type="button"
              className="px-8 py-3 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 hover:from-purple-500 hover:via-blue-500 hover:to-indigo-500 rounded-lg font-bold responsive-text-lg text-white transition-all duration-300 cursor-pointer select-none transform hover:scale-110 shadow-2xl relative overflow-hidden"
          ...
          <div className="relative">
            <button 
              type="button"
              className="px-12 py-4 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-400 hover:via-orange-400 hover:to-red-400 rounded-xl font-bold responsive-text-xl text-black transition-all duration-300 cursor-pointer select-none transform hover:scale-110 shadow-2xl relative overflow-hidden hover:shadow-yellow-500/50"
