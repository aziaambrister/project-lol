...
const StartScreen: React.FC<StartScreenProps> = ({ onStart, onBack }) => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-b from-slate-900 via-purple-900 to-black text-white p-2 relative overflow-hidden">
      {/* Back Button */}
      <button
        onClick={onBack}
      ...
      <div className="max-w-5xl w-full text-center relative z-10">
        <div className="mb-4">
          <h1 className="text-4xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 animate-pulse">
            Fighter's Realm
          </h1>
          <div className="flex items-center justify-center space-x-2 text-base text-gray-300 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          <div 
            className="bg-gray-800 bg-opacity-60 p-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-red-500/20"
            onMouseEnter={() => setHoveredFeature('combat')}
            onMouseLeave={() => setHoveredFeature(null)}
          >
            <div className="w-10 h-10 bg-red-900 bg-opacity-60 rounded-full flex items-center justify-center mx-auto mb-2 relative">
              <Target size={20} className="text-red-400" />
              {hoveredFeature === 'combat' && (
                <div className="absolute inset-0 bg-red-500 rounded-full animate-ping opacity-30"></div>
              )}
            </div>
            <h3 className="text-sm font-bold mb-1">Fluid Combat</h3>
          ...
          <div 
            className="bg-gray-800 bg-opacity-60 p-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-blue-500/20"
            onMouseEnter={() => setHoveredFeature('world')}
            onMouseLeave={() => setHoveredFeature(null)}
          >
            <div className="w-10 h-10 bg-blue-900 bg-opacity-60 rounded-full flex items-center justify-center mx-auto mb-2 relative">
              <Shield size={20} className="text-blue-400" />
              {hoveredFeature === 'world' && (
                <div className="absolute inset-0 bg-blue-500 rounded-full animate-ping opacity-30"></div>
              )}
            </div>
            <h3 className="text-sm font-bold mb-1">Open World</h3>
          ...
          <div 
            className="bg-gray-800 bg-opacity-60 p-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-purple-500/20"
            onMouseEnter={() => setHoveredFeature('ai')}
            onMouseLeave={() => setHoveredFeature(null)}
          >
            <div className="w-10 h-10 bg-purple-900 bg-opacity-60 rounded-full flex items-center justify-center mx-auto mb-2 relative">
          ...
          <div 
            className="bg-gray-800 bg-opacity-60 p-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-opacity-80 border border-green-500/20"
            onMouseEnter={() => setHoveredFeature('characters')}
            onMouseLeave={() => setHoveredFeature(null)}
          >
            <div className="w-10 h-10 bg-green-900 bg-opacity-60 rounded-full flex items-center justify-center mx-auto mb-2 relative">
              <Users size={20} className="text-green-400" />
              {hoveredFeature === 'characters' && (
                <div className="absolute inset-0 bg-green-500 rounded-full animate-ping opacity-30"></div>
              )}
            </div>
            <h3 className="text-sm font-bold mb-1">Unique Fighters</h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-4">
          ...
          <div className="relative">
            <button 
              type="button"
              className="px-6 py-2 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 hover:from-purple-500 hover:via-blue-500 hover:to-indigo-500 rounded-lg font-bold text-base text-white transition-all duration-300 cursor-pointer select-none transform hover:scale-110 shadow-2xl relative overflow-hidden"
          ...
          <div className="relative">
            <button 
              type="button"
              className="px-10 py-3 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-400 hover:via-orange-400 hover:to-red-400 rounded-xl font-bold text-lg text-black transition-all duration-300 cursor-pointer select-none transform hover:scale-110 shadow-2xl relative overflow-hidden hover:shadow-yellow-500/50"
        ...
        <a 
          ...
          className="mt-4 inline-block bg-gray-800 bg-opacity-60 px-3 py-1 rounded-full text-xs font-medium hover:bg-opacity-80 transition-all duration-300 border border-gray-600 hover:border-gray-400"
        >
          ⚡ Built with Bolt.new
        </a>
      </div>
