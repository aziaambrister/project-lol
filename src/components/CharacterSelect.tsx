...
const CharacterSelect: React.FC<CharacterSelectProps> = ({ onSelectComplete, onBack }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white responsive-p-4 overflow-hidden">
      {/* Back Button */}
      <button
        onClick={onBack}
      ...
      <h1 className="responsive-text-3xl lg:text-4xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">
        Choose Your Fighter
      </h1>
      <p className="text-gray-300 mb-6 text-base">Select your character to begin your journey</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 responsive-gap-4 lg:gap-6 w-full max-w-6xl mb-8">
        {characters.map(character => {
          ...
          return (
            <div 
              key={character.id}
              className={`relative border-2 rounded-lg responsive-p-4 transition-all duration-300 transform cursor-pointer ${
                isSelected 
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                ...
                <div className="flex items-center bg-slate-700 p-2 rounded-lg">
                  <Sword className="text-orange-500 mr-1" size={16} />
                  <div>
                ...
                <div className="flex items-center bg-slate-700 p-2 rounded-lg">
                  <Shield className="text-blue-500 mr-1" size={16} />
                  <div>
      ...
      <div className="relative">
        <button 
          type="button"
          className={`px-16 py-4 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-400 hover:via-orange-400 hover:to-red-400 rounded-xl font-bold responsive-text-xl text-black transition-all duration-300 cursor-pointer select-none transform hover:scale-110 shadow-2xl relative overflow-hidden ${
