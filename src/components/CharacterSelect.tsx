...
const CharacterSelect: React.FC<CharacterSelectProps> = ({ onSelectComplete, onBack }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white p-4 overflow-hidden compact-container">
      {/* Back Button */}
      <button
        onClick={onBack}
      ...
      <h1 className="text-4xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">
        Choose Your Fighter
      </h1>
      <p className="text-gray-300 mb-6 text-base">Select your character to begin your journey</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-6xl mb-8 compact-grid">
        {characters.map(character => {
          ...
          return (
            <div 
              key={character.id}
              className={`relative border-2 rounded-lg p-4 transition-all duration-300 transform cursor-pointer compact-spacing ${
                isSelected 
            ...
            >
              ...
              <div className="mb-3 text-xs text-gray-300 compact-text">
              ...
              <div className="grid grid-cols-2 gap-2 mb-4 compact-grid">
              ...
              <div className="text-xs text-gray-400 compact-text">
      ...
      <div className="mt-6 text-center text-xs text-gray-400 compact-text">
