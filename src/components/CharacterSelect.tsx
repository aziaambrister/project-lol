  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white overflow-hidden">
      ...
      <div className="content-container">
        <h1 className="responsive-text-4xl lg:responsive-text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 text-center">
          Choose Your Fighter
        </h1>
        <p className="text-gray-300 mb-8 responsive-text-lg text-center">Select your character to begin your journey</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 responsive-gap-6 w-full max-w-7xl mb-10">
          {characters.map(character => {
            ...
            return (
              <div 
                key={character.id}
                className={`relative border-2 rounded-lg responsive-p-6 transition-all duration-300 transform cursor-pointer ${
                  isSelected 
              ...
              >
                {/* Character Portrait */}
                <div className="w-full h-40 mb-6 overflow-hidden rounded-lg bg-slate-900 flex items-center justify-center relative">
                  <img 
                  ...
                  {!isUnlocked && (
                    <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        {isPremium ? (
                          <div className="text-yellow-400 font-bold responsive-text-sm">Premium Purchase Required</div>
                        ) : (
                          <div className="text-yellow-400 font-bold responsive-text-sm">{character.price} coins</div>
                        )}
                      </div>
                    </div>
                  )}
                ...
                <h3 className="responsive-text-xl font-bold mb-3">{character.name}</h3>
                <div className="mb-4 responsive-text-base text-gray-300">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  <div className="flex items-center bg-slate-700 p-3 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="font-bold responsive-text-base">{character.health}</div>
                    </div>
                  </div>
                  <div className="flex items-center bg-slate-700 p-3 rounded-lg">
                    <Sword className="text-orange-500 mr-2" size={18} />
                    <div>
                      <div className="text-xs text-gray-400">Attack</div>
                      <div className="font-bold responsive-text-base">{character.attack}</div>
                    </div>
                  </div>
                  <div className="flex items-center bg-slate-700 p-3 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="font-bold responsive-text-base">{character.defense}</div>
                    </div>
                  </div>
                  <div className="flex items-center bg-slate-700 p-3 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="font-bold responsive-text-base">{character.speed}</div>
                    </div>
                  </div>
                </div>
                
                {/* Move Set Preview */}
                <div className="responsive-text-base text-gray-400">
                ...
                {isSelected && (
                  <div className="absolute top-3 right-3 z-10">
                    <div className="bg-yellow-400 text-black font-bold px-3 py-2 rounded-full responsive-text-sm animate-pulse">
                      ✓ SELECTED
                    </div>
                  </div>
                )}
        ...
        <div className="mb-8 text-center">
          <p className="responsive-text-xl text-gray-300">
            Selected: <span className="text-yellow-400 font-bold responsive-text-2xl">
              {characters.find(c => c.class === selectedClass)?.name || 'None'}
            </span>
          </p>
          <p className="responsive-text-base text-gray-400 mt-2">
        ...
        {/* Controls hint */}
        <div className="mt-8 text-center responsive-text-base text-gray-400">
